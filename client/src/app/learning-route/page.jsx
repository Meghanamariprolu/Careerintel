            ...
            <div className="max-w-5xl mx-auto relative z-10">
                <header className="mb-16 text-center">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-6 text-xs font-black uppercase tracking-[0.2em] text-purple-300 shadow-xl"
                    >
                    ...
                    <motion.h1
                        ...
                        className="text-lg md:text-2xl font-black mb-4 tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-purple-400 drop-shadow-2xl uppercase"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-sm md:text-lg text-white/40 max-w-2xl mx-auto font-medium leading-relaxed"
                    >
                ...
                {!route ? (
                    ...
                    >
                        ...
                        <div className="bg-white/5 backdrop-blur-2xl p-8 md:p-12 rounded-[3rem] border border-white/10 shadow-3xl overflow-hidden relative">
                            ...
                            <div className="relative z-10">
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                                    <div>
                                        ...
                                        <p className="text-purple-300/40 font-bold uppercase tracking-widest text-sm mt-1">Specialization Curriculum</p>
                                    </div>
                                    <div className="flex items-center gap-2 bg-purple-500/10 text-purple-300 px-5 py-2 rounded-2xl text-sm font-black border border-purple-500/20 shadow-lg">
                        ...
                        <div className="flex justify-center">
                            <Link href="/dashboard">
                                <motion.button
                                    whileHover={{ x: -5 }}
                                    className="flex items-center gap-2 text-white/30 hover:text-white font-bold transition-colors"
                                >
