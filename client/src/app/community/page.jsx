    ...
    return (
        <div className="min-h-screen bg-[#050510] text-white font-sans overflow-x-hidden">
            ...
            <div className="relative py-20 px-6 text-center overflow-hidden">
                ...
                <h1 className="text-3xl md:text-5xl font-light  text-white mb-4">Community</h1>
            ...
            <div className="max-w-6xl mx-auto px-6 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                    {highlights.map((h, idx) => (
                        <motion.div key={h.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }} className="p-6 rounded-xl bg-white/[0.03] border border-white/10 text-center">
                            <h.icon className="h-5 w-5 text-white/60 mx-auto mb-3" />
                ...
                {/* Channels */}
                <h2 className="text-xl font-light text-white mb-8 ">Join the Conversation</h2>
