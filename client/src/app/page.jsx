...
import { ArrowRight, Sparkles, Target, Compass, TrendingUp, ShieldCheck, Zap, Users, Star, BarChart3, Globe } from "lucide-react";
...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-[#09090b] text-white font-sans">
      {/* Sticky Header */}
      <header className="px-4 sm:px-6 lg:px-12 py-4 flex items-center justify-between border-b border-white/5 backdrop-blur-md sticky top-0 z-50 bg-[#09090b]/80">
      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-20 pb-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/20 bg-purple-500/10 text-purple-300 text-xs uppercase tracking-widest mb-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <div className="text-xs sm:text-sm text-white/50 uppercase tracking-widest">{stat.label}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="features" className="py-20 px-4 sm:px-6 lg:px-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 text-white/60 text-xs uppercase tracking-widest mb-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="group p-6 rounded-2xl border border-white/6 bg-white/3 hover:border-purple-500/30 hover:bg-purple-500/5 transition-all duration-300 cursor-default"
                >
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-12 bg-white/[0.01]">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/10 text-blue-300 text-xs uppercase tracking-widest mb-4">
                  <Globe className="h-3.5 w-3.5" /> Global Integrations
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight">
                  Master Your Presence <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
                    Across the Tech Ecosystem
                  </span>
                </h2>
              </div>
              <p className="text-white/40 text-sm md:text-lg max-w-sm">
                CareerIntel bridges the gap between your local skills and your global professional presence.
              </p>
            </div>
