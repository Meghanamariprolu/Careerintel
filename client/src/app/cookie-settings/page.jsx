    ...
    return (
        <div className="min-h-screen bg-[#050510] text-white font-sans overflow-x-hidden">
            <div className="relative py-20 px-6 text-center overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 text-xs   text-orange-300">
                    <Cookie className="h-3 w-3" /> Privacy Controls
                </motion.div>
                <h1 className="text-3xl md:text-5xl font-light  text-white mb-4">Cookie Settings</h1>
            ...
            <div className="max-w-3xl mx-auto px-6 pb-24 space-y-6">
                        ...
                        <div className="flex items-start justify-between gap-6">
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    {type.required && <span className="text-sm px-2 py-0.5 bg-white/5 border border-white/10 rounded-full text-white/60">Required</span>}
                                </div>
                                <p className="text-white/70 text-sm leading-relaxed mb-4">{type.description}</p>
                                <div>
                                    <p className="text-xs text-white/75   mb-2">Examples:</p>
                ...
                <div className="flex gap-4 pt-4">
                    <button className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 text-white/90 text-sm hover:bg-white/10 transition-colors">
                        Reject All Optional
                    </button>
