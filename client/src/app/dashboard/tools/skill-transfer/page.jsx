            ...
            <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 text-[10px] md:text-xs  uppercase tracking-[0.25em] text-cyan-300 shadow-xl"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                    <div className="space-y-4">
                        <h2 className="text-base md:text-xl  text-white/80 flex items-center gap-3 mb-6">
                        ...
                        {transferMap.map((path, idx) => (
                            <motion.div
                                ...
                                className="p-8 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-500/30 transition-all group overflow-hidden relative"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="px-3 py-1 bg-cyan-500/10 rounded-full border border-cyan-500/20">
                                            <span className="text-[10px] md:text-xs  uppercase tracking-widest text-cyan-400">{path.strength} Match</span>
                                        </div>
                                    </div>
                    ...
                    <motion.div
                        ...
                        className="p-10 rounded-xl bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent border border-cyan-500/20 backdrop-blur-3xl flex flex-col justify-between"
                    >
                        <div>
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    <h2 className="text-base md:text-xl  text-white uppercase tracking-widest">Pivot Strategy</h2>
                                    <p className="text-[10px] md:text-xs text-cyan-400/60  uppercase tracking-widest">Bridge Your Excellence</p>
                                </div>
                            </div>
                            <p className="text-sm md:text-lg text-white/60 leading-relaxed  mb-12">
                                "Based on your technical proficiency and behavioral profile, a pivot into <span className="text-cyan-400 ">AI Solutions Engineering</span> offers a 45% shorter learning curve than typical candidates. Your background in Data Analysis provides the 'Logical Foundation' required for complex LLM orchestrations."
                            </p>
                        </div>
