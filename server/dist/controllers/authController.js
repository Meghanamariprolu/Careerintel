...
exports.resetPassword = exports.forgotPassword = exports.updateProfile = exports.getUserProfile = exports.logoutUser = exports.loginUser = exports.registerUser = void 0;
...
exports.registerUser = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    if (user) {
        const token = (0, generateToken_1.generateToken)(res, user._id.toString(), user.role);
        res.status(201).json({
            _id: user._id,
            name: user.name,
            email: user.email,
...
exports.updateProfile = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    if (user) {
        ...
        res.status(200).json({
            ...
            token: (0, generateToken_1.generateToken)(res, updatedUser._id.toString(), updatedUser.role),
        });
    }
    else {
        res.status(404);
