                ...
                <div className="space-y-6">
                    {resources.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="relative p-8 rounded-xl bg-white/5 border border-white/10 hover:border-orange-500/30 transition-all flex flex-col md:flex-row md:items-center justify-between gap-8 backdrop-blur-xl">
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-3 mb-2">
                                            <span className="text-[10px] md:text-xs  uppercase tracking-widest text-orange-400/60">{item.platform}</span>
                                            <span className="h-1 w-1 bg-white/10 rounded-full" />
                                            <span className="text-[10px] md:text-xs  uppercase tracking-widest text-white/30">{item.category}</span>
                                        </div>
                                        <h3 className="text-base md:text-xl  text-white group-hover:text-orange-400 transition-colors">{item.title}</h3>
                                        <div className="flex items-center gap-2 mt-4">
                                            <ShieldCheck className="h-4 w-4 text-green-400" />
                                            <span className="text-xs md:text-base  text-green-400/80">{item.badge}</span>
                                        </div>
                                    </div>
                                </div>
