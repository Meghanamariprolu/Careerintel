            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            {traits.map((trait, idx) => (
                                <motion.div
                                    ...
                                    className="p-6 rounded-xl bg-white/5 border border-white/10 hover:border-pink-500/30 transition-all group"
                                >
                                    <div className="flex justify-between items-center mb-4">
                                        <h3 className="text-base md:text-xl  text-white group-hover:text-pink-400 transition-colors uppercase tracking-tight">{trait.name}</h3>
                                        <span className="text-lg md:text-2xl  text-pink-400">{trait.value}%</span>
                                    </div>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, scale: 1 }}
                        className="p-10 rounded-xl bg-gradient-to-br from-pink-500/10 via-purple-500/5 to-transparent border border-pink-500/20 backdrop-blur-3xl relative overflow-hidden group"
                    >
                        ...
                        <div className="relative z-10">
                            <h2 className="text-base md:text-xl  text-white mb-6 uppercase tracking-widest">AI Behavioral Insight</h2>
                            <p className="text-sm md:text-lg text-white/70 leading-relaxed  mb-8">
                                "Your profile shows a rare combination of <span className="text-pink-400 ">Strategic Precision</span> and <span className="text-purple-400 ">High Empathy</span>. This makes you an ideal candidate for 'Product Leadership' and 'Client-Facing Strategy' roles where trust and ROI are interdependent."
                            </p>
