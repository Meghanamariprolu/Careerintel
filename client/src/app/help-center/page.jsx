            ...
            <div className="relative py-20 px-6 text-center overflow-hidden">
                ...
                <div className="relative max-w-xl mx-auto">
                    ...
                    <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-6 text-white placeholder:text-white/20 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all"
                    />
                </div>
            </div>
                ...
                {filteredFaqs.map((cat) => (
                    <section key={cat.category}>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-xl font-light text-white tracking-wide">{cat.category}</h2>
                        </div>
