...
export default function AdminDashboardPage() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl   text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan to-deep-purple">Platform Analytics</h1>
                    ...
                    <CardContent className="p-0">
                        <div className="overflow-x-auto w-full">
                            <table className="w-full text-sm text-left">
                                <thead className="text-xs  bg-secondary/50 text-muted-foreground border-b border-border">
                                    <tr>
                                    ...
                                    {usersList.slice(0, 10).map((u) => (
                                        <tr key={u.id || u._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2 py-1 rounded-full text-sm   r ${u.role === 'admin' ? 'bg-deep-purple/20 text-deep-purple border border-deep-purple/30' : 'bg-neon-cyan/20 text-neon-cyan border border-neon-cyan/30'}`}>
                                                    {u.role}
                                                </span>
                                            </td>
