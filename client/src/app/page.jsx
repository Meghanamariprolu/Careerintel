    ...
    <div className="flex min-h-screen flex-col bg-background font-sans">
      <header className="px-6 py-4 flex items-center justify-between border-b border-border/40 backdrop-blur-sm sticky top-0 z-50">
        ...
        <nav className="flex items-center gap-4">
          ...
          <Link href="/register">
            <Button size="sm" className="bg-neon-cyan text-black hover:bg-neon-cyan/80 ">Get Started</Button>
          </Link>
        </nav>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-b from-background to-background/80">
        <div className="max-w-3xl space-y-8">
          <div className="inline-flex items-center rounded-full border border-neon-cyan/20 bg-neon-cyan/10 px-3 py-1 text-sm  text-neon-cyan shadow-[0_0_15px_rgba(168,85,247,0.1)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/register">
              <Button size="lg" className="h-12 px-8 text-base bg-deep-purple hover:bg-deep-purple/80 text-white shadow-[0_0_20px_rgba(112,0,255,0.3)] ">
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
          <div className="space-y-4 p-6 rounded-xl border border-white/10 bg-slate-900/40 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.2)]">
            <Target className="h-10 w-10 text-neon-cyan" />
            <h3 className="text-xl ">Personalized Plans</h3>
          ...
          <div className="space-y-4 p-6 rounded-xl border border-white/10 bg-slate-900/40 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.2)]">
            ...
            <h3 className="text-xl ">Market Intelligence</h3>
          ...
          <div className="space-y-4 p-6 rounded-xl border border-white/10 bg-slate-900/40 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.2)]">
            ...
            <h3 className="text-xl ">Actionable Steps</h3>
