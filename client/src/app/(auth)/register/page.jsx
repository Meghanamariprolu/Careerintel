...
import { Loader2, Mail, Lock, User, ArrowRight, Sparkles, CheckCircle2, Eye, EyeOff } from"lucide-react"
            ...
            <div className="hidden lg:flex flex-col justify-between w-[45%] bg-gradient-to-br from-indigo-950/60 via-[#09090b] to-purple-950/40 border-r border-white/5 p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-4 pt-4">
                        {["Unlock 12+ AI Career Tools","Generate Precision Roadmaps","ATS-Grade Resume Enhancement","AI-Powered Learning Progress Tracking"
                        ].map((item) => (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 py-16 overflow-y-auto">
                ...
                <div className="w-full max-w-md space-y-10">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-white/80 text-base">Enter your details and begin your AI-guided journey</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/60 group-focus-within:text-indigo-400 transition-colors pointer-events-none" />
                                <Input id="name" type="text" placeholder="e.g. Alexander Pierce" className="pl-12 bg-white/5 border-white/10 text-white placeholder:text-white/70 focus:border-indigo-500/50 focus:ring-indigo-500/20 h-14 rounded-2xl transition-all"
                                    {...register("name")}
                                />
                            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/60 group-focus-within:text-indigo-400 transition-colors pointer-events-none" />
                                <Input id="email" type="email" placeholder="name@company.com" className="pl-12 bg-white/5 border-white/10 text-white placeholder:text-white/70 focus:border-indigo-500/50 focus:ring-indigo-500/20 h-14 rounded-2xl transition-all"
                                    {...register("email")}
                                />
                            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/60 group-focus-within:text-indigo-400 transition-colors pointer-events-none" />
                                <Input id="password"
                                    type={showPassword ?"text" :"password"} placeholder="Minimum 8 characters" className="pl-12 pr-12 bg-white/5 border-white/10 text-white placeholder:text-white/70 focus:border-indigo-500/50 focus:ring-indigo-500/20 h-14 rounded-2xl transition-all"
                                    {...register("password")}
                                />
                                <button type="button"
                                    onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-white/60 hover:text-white/90 transition-colors"
                                >
                        ...
                        {/* Feedback / Terms */}
                        <div className="text-xs text-white/70 leading-relaxed px-1">
                        ...
                        <Button type="submit" className="w-full h-14 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold text-lg rounded-2xl shadow-xl shadow-indigo-950/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                                <>
